...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, directory,file_folder, batch_size=8, dim=(384,384,36), n_channels=1,
                 ...
                 flipProbability = -1,cropDim=(384,384,36)):
        'Initialization'
        self.dim = dim
...
tf.app.flags.DEFINE_string('test_csv_path', '/gpfs/data/denizlab/Users/hrr288/data/OAI_COR_TSE_test.csv', 'Folder with the test csv')
...
tf.app.flags.DEFINE_string('train_file_folder','/gpfs/data/denizlab/Datasets/OAI/COR_IW_TSE/', 'Path to HDF5 radiographs of OAI train/val set')
