...
class roc_callback(Callback):
    def __init__(self,index,val_fold):
        _params = {'dim': (352,352,35),
              ...
              'flipProbability' : -1,
              'cropDim' : (352,352,35)}
        self.x = DataGenerator(directory = '/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(index)+'_train.csv', file_folder=FLAGS.file_folder, **_params)
        self.x_val = DataGenerator(directory = '/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(index)+'_val.csv',file_folder=FLAGS.file_folder,  **_params)
        self.y = pd.read_csv('/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(index)+'_train.csv').Label
        self.y_val = pd.read_csv('/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(index)+'_val.csv').Label
        self.auc = []
        self.val_auc = []
        self.losses = []
        self.val_losses = []
...
def cross_validation(val_fold, lr, filters_in_last, file_path):
    ...
    for i in range(num_of_folds):
        ...
        training_generator = DataGenerator(directory = '/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(i+1)+'_train.csv',file_folder=FLAGS.file_folder,  **train_params)
        validation_generator = DataGenerator(directory = '/gpfs/data/denizlab/Users/hrr288/Tianyu_dat/COR_TSE/Fold_'+str(val_fold)+'/CV_'+str(i+1)+'_val.csv',file_folder=FLAGS.file_folder,  **val_params)
